                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="orden in arrayOrden" :key="orden.id">
                                        <td>
                                            <button type="button" @click="verorden(orden.id)" class="btn btn-success btn-sm">
                                            <i class="icon-eye"></i>
                                            </button> &nbsp;
                                            ...
                                            <template v-if="orden.estado=='Registrado'">
                                                <button type="button" class="btn btn-danger btn-sm" @click="desactivarOrden(orden.id)">
                                        ...
                                        <td v-text="orden.dnicliente"></td>
                                        <td v-text="orden.nombre_cliente"></td>
                                        <td v-text="orden.telefono"></td>
                                        <td v-text="orden.destino"></td>
                                        <td v-text="orden.distrito"></td>
                                        <td v-text="orden.movilidad"></td>
                        ...
                        <div class="form-group row border">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" v-model="dnicliente" placeholder="DNI o RUC">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Cliente(*)</label>
                                    <input type="text" class="form-control" v-model="nombre_cliente" placeholder="Cliente">
                                </div>
                            </div>
                             <div class="col-md-2">
                                <div class="form-group">
                                    <label>Teléfono (*)</label>
                                    <input type="text" class="form-control" v-model="telefono" placeholder="Nro de Teléfono">
                                </div>
                            </div>
                              <div class="col-md-8">
                                <div class="form-group">
                                    <label>Destino (*)</label>
                                    <input type="text" class="form-control" v-model="destino" placeholder="Dirección de Entrega">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Distrito</label>
                                    <select class="form-control" v-model="distrito">
                                        <option value="0">Seleccione</option>
                                        <option value="SAN ISIDRO">SAN ISIDRO</option>
                                        <option value="MIRAFLORES">MIRAFLORES</option>
                                        <option value="SURCO">SURCO</option>
                                        <option value="SURCO">SAN BORJAS</option>
                                        <option value="SURCO">CHORRILLOS</option>
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" v-model="orden_entrega" placeholder="">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Movilidad (*)</label>
                                    <input type="text" class="form-control" v-model="movilidad" placeholder="Movilidad">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" v-model="observacion" placeholder="Información adicional">
                                </div>
                            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        <tr v-for="articulo in arrayArticulo" :key="articulo.codigo">
                                            <td>
                            ...
                            <ul class="pagination">
                                <li class="page-item" v-if="pagination.current_page > 1">
                                    <a class="page-link" href="#" @click.prevent="cambiarPaginaArticulos(pagination.current_page - 1,buscarA,criterioA)">Ant</a>
                                </li>
                                <li class="page-item" v-for="page in pagesNumber" :key="page" :class="[page == isActived ? 'active' : '']">
                                    <a class="page-link" href="#" @click.prevent="cambiarPaginaArticulos(page,buscarA,criterioA)" v-text="page"></a>
                                </li>
                                <li class="page-item" v-if="pagination.current_page < pagination.last_page">
                                    <a class="page-link" href="#" @click.prevent="cambiarPaginaArticulos(pagination.current_page + 1,buscarA,criterioA)">Sig</a>
                                </li>
                            </ul>
                        </nav>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            buscarArticulo(){
                let me=this;
                var url= this.ruta + '/articulo/buscarArticuloPedido?filtro=' + me.codigo;
            ...
            cambiarPaginaArticulos(page,buscar,criterio){
                let me = this;
                //Actualiza la página actual
                me.pagination.current_page = page;
                //Envia la petición para visualizar la data de esa página
            ...
            listarArticulo (page,buscar,criterio){
                let me=this;
                var url= this.ruta + '/articulo/listarArticuloPedido?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
            ...
            validarPedido(){
                ...
                if (me.dnicliente==0) me.errorMostrarMsjVenta.push("Seleccione un Cliente");
                if (me.nombre_cliente==0) me.errorMostrarMsjVenta.push("Seleccione un Cliente");
