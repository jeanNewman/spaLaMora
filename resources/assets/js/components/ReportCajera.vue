      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <i class="fa fa-align-justify"></i> Reporte de Cajera
          </div>
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                   ...
                   <button type="submit" @click="listarPedidos(1,buscar,criterio,buscar2,criterio3,criterio2,fechaCreacion,2)"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      listarPedidos(valor, buscar, criterio,buscar2,criterio3,criterio2,fechaCreacion,dato) {

        let me = this;

        //Obtener los datos del ingreso
        me.vista = dato;
        var url = this.ruta + '/orden/repostCajera?creacion=' + fechaCreacion + 
          buscar + '&criterio=' + criterio + '&buscar2=' +
          buscar2 + '&criterio3=' + criterio3 +  '&criterio2=' + criterio2;
