        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
              <div class="col-md-6">
                <div class="form-group">
                  <button type="submit" @click="listarOrden(fechaIni,fechaFin,horaIni,horaFin,criterio2,fechaCreacionInicial,fechaCreacionFinal,criterio,buscar)"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      listarOrden(fechaIni, fechaFin,horaIni,horaFin,criterio2,fechaCreacionInicial,fechaCreacionFinal,criterio,buscar) {
        let me = this;
