            ...
            <div class="form-group row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                   ...
                   <button type="submit" @click="listarPedidos(1,buscar,criterio,buscar2,criterio3,fechaCreacion,2)"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      listarPedidos(valor, buscar, criterio,buscar2,criterio3,fechaCreacion,dato) {

        let me = this;

        //Obtener los datos del ingreso
        me.vista = dato;
        var url = this.ruta + '/orden/rptCajera?creacion=' + fechaCreacion + '&buscar=' +
          buscar + '&criterio=' + criterio + '&buscar2=' +
          buscar2 + '&criterio3=' + criterio3 ;
