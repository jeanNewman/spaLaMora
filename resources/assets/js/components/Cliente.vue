                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div  class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="id_juntos" class="form-control" placeholder="Número de documento">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    export default {
        ...
        methods : {
            ...
            validarPersona(){
                ...
                if (!this.telefono) this.errorMostrarMsjPersona.push("Colcar el nro de teléfono");
