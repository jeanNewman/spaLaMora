  ...
  methods: {
      ...
      async checkCSV(sepComa) {
        ...
        function agregarCabecera(element) {
          ...
          direccionShipping = element.shipping_street + " " + element.shipping_address1 + " " + element.shipping_address2
          direccionBilling = element.billing_street + " " + element.billing_address1 + " " + element.billing_address2
          ...
          me.num_documento = isNaN(element.billing_city) ? '' : element.billing_city;
          me.idJuntos = '';
          ...
          me.distrito = zona;
          me.formaPago = "MERCADO PAGO";
          me.banco = "MERCADO PAGO";
          ...
          me.observacion = element.notes.replace(/["']/g, "");
          me.codigo = '';
